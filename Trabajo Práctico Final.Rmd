...
Podemos advertir varias cuestiones: \* Nuestro dataset cuenta con 3176 casos y 18 variables \* Los nombres de las variables no necesitan ser limpiados (de momento) \* Los casos listados difieren según rubro, subrubro, programa, subprograma, provincia y ciudad, sólo por nombrar algunas variables.
...
1º Empecemos por ver la cantidad de etiquetas que hay. El actual dataset contiene información sobre organizaciones certificadas por el Estado Nacional en diversas materias que hacen a la calidad turística. Veamos cuales son las que más se repiten:

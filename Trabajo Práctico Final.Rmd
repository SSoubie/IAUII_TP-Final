...
Con respecto a la situación en Argentina, durante la última década, el sector turístico ha realizado sus primeros pasos hacia la sostenibilidad, a partir de la incorporación de nuevas tecnologías y procesos aamigables con el medio ambiente. Pese a ello y al gran potencial "verde" que posee esta industria en el país, no existen grandes precisiones sobre  el estado actual de la cuestion.

Con ello en vista, el siguiente trabajo se propone hacer un aporte a la discuón  sobre el nivel actual de la transición verde en sector turístico. Con tal fin, se realiza un análisis de los establecimientos locales certificados con las directrices ambientales otorgadas por el Ministerio de Turismo y Deportes de la Nación. Particularmente, buscamos responder:
...
En la primera parte del proyecto trabajaremos sobre el dataset de organizaciones distinguidas por el Sistema Argentino de Calidad Turística (SACT) perteneciente al Ministerio de Turismo y Deporte de la Nación. El mismo se encuentra disponible en <http://datos.yvera.gob.ar/>.
...
A continuacón, analizaremos con mayor profundidad nuestro dataset. Para ello, nuestro primer paso consiste en "limpiar" nuestra base de datos.
...
Podemos ver que varias organizaciones se repiten en nuestro dataset. Ello puede ser porque cuentan con más de una certificación. Para asegurarnos de ello, quedemosnos solo con los valores únicos.
...
Vemos que algunas categorías repiten las mismas temáticas. Agrupemoslas:
...
**Alojamiento** (1237), seguido, aunque por bastante diferencia, de **Gastronomía** (448) y **Agencia de viaje** (346) son los rubros más frecuentes de nuestra tabla.
...
En cuanto a las calles y sus alturas, vemos que hay una gran variedad de datos y que no toda la información corresponde con direcciones específicas. A los fines de este trabajo, no ahondaremos en estas cuestiones, pero sugerimos incorporar mayores estándares en la carga de esta información.

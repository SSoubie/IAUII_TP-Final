...
Sin embargo, sería interesante poder evaluar cuáles fueron los años en los que se entregó la mayor cantidad. 
...
RETOCAR TAMBIEN PARA QUE DE EL AÑO DE UNA
```{r}
...
RETOCAR PARA OBTENER INFO OK DE UNA
```{r}
ambientales_ano_rubro %>% 
  apply (2, which.max)
```

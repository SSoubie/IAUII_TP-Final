...
Frente a esta situación, distintas industrias han iniciado el camino hacia la sostenibilidad, entre las que podemos encontrar el sector turístico. El turismo ........ (FLOR, ACÁ PODEMOS PONER ALGO DEL IMPACTO DEL PLÄSTTICO QUE HICIMOS PARA DIANA)
...
Finalmente, veamos cuáles son los organismos certificantes.
...
El IRAM es el organismo certificante que más veces se encuentra nombrado, aunque, curiosamente, el Ministerio de Turismo de la Nación no resulta mencionado. Pese a ello, se infiere que los NAs existentes (2972) corresponden con directrices otorgadas por este último.
